...
const Description = () => {
  return (
    <div>
      <div></div>
      <div className='flex justify-center gap-16 sm:gap-8 mt-20'>
      ...
      <div className='container mx-auto px-4 sm:max-w-full md:max-w-[1100px]'>
        <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-8 md:gap-20'>
          <div>
          ...
          <div>
            <img className='w-full max-w-[500px] mx-auto sm:w-full md:w-[500px]' src="https://res.cloudinary.com/da43e0ikj/image/upload/v1737278540/h44ffe1mlhs9oksf6vj8.png" alt="" />
            <div className='flex flex-wrap gap-4 border border-gray-400 mt-6 p-4'>
              <div className='flex items-center gap-2'>
                <img className='w-10 h-10 bg-green-400 rounded-full' src="https://res.cloudinary.com/da43e0ikj/image/upload/v1737278538/uplpwyogowludalvrchw.png" alt="" />
                <p>64% Discount<br />Save your 64% money with us</p>
              </div>
              <div className='flex items-center gap-2'>
                <img className='w-10 h-10 bg-green-400 rounded-full' src="https://res.cloudinary.com/da43e0ikj/image/upload/v1737278381/ee46kxu54l0gjqoimrbn.png" alt="" />
