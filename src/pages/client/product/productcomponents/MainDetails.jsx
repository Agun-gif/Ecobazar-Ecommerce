...
const MainDetails = () => {
    return (
        <div>
            <div className='container mx-auto max-w-full sm:max-w-[1000px]'>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
                    <div className='flex flex-col sm:flex-row gap-4 sm:gap-8 overflow-hidden'>
                        <div className='flex gap-4 sm:flex-col'>
                            <img className='w-full sm:w-auto' src="https://res.cloudinary.com/da43e0ikj/image/upload/v1737276214/s4awds46qa5t6jdnp3fd.png" alt="" />
                            <img className='w-full sm:w-auto' src="https://res.cloudinary.com/da43e0ikj/image/upload/v1737276214/ggx3nfhhqajiix3el5lb.png" alt="" />
                            <img className='w-full sm:w-auto' src="https://res.cloudinary.com/da43e0ikj/image/upload/v1737276214/l6llsylblb3ck6xtlykp.png" alt="" />
                            <img className='w-full sm:w-auto' src="https://res.cloudinary.com/da43e0ikj/image/upload/v1737276214/vexhmye74o5argvdojbv.png" alt="" />
                        </div>
                        <div>
                            <img className='w-full sm:w-[400px]' src="https://res.cloudinary.com/da43e0ikj/image/upload/v1736520266/ffnqnmavmxhurfpf06pl.png" alt="" />
                        </div>
                    </div>

                    <div>
                        <div className='flex flex-col sm:flex-row gap-4'>
                            <p className='text-4xl sm:text-6xl font-bold'>Chinese Cabbage</p>
                            <p className='bg-green-200 w-32 h-8 text-center text-2xl rounded-lg mt-6'>In Stock</p>
                        </div>
                        ...
                        <div className='border border-gray-300 w-full sm:w-[500px]'></div>
                        ...
                        <div className='flex flex-col sm:flex-row gap-8 py-6'>
                            <div className='flex items-center gap-2 border border-gray-400 px-2 py-0 rounded-full'>
                        ...
                        <div>
                            ...
                            <div className='flex gap-2'>
                                ...
                                <p className='text-xl'>Chinese : Cabbage Green Cabbage</p>
                            </div>
                        </div>
                    </div>
                </div>
