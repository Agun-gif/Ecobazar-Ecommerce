                ...
                <div className='flex gap-10'>
                    <div className='border border-gray-300 w-[820px] m-4 rounded-lg '>
                        ...
                        <div className='flex items-center'>
                            ...
                            <p className='text-xl ml-20'>$14.00</p>
                            <div className='flex gap-2 border border-gray-300 h-8 w-16 items-center rounded-full ml-64'>
                                <CiCircleMinus className='text-xl' /><p className='text-xl'>5</p><CiCirclePlus className='text-xl' />
                            </div>
                            <p className='text-xl ml-64'>$70.00</p>
                        ...
                        <div className='flex justify-between m-2'>
                            <button className='border border-gray-400 rounded-full bg-gray-200 px-2 py-2'>Return To Shop</button>
                            <button className='border border-gray-400 rounded-full bg-gray-200 px-2 py-2'>Update Cart</button>
                        </div>
                    </div>
                    <div className='border border-gray-300 w-[500px] rounded-lg mt-4 '>
                        <p className='text-2xl p-4'>Cart Total</p>
                        <div>
                            <div className='flex justify-between items-center'>
                                <p className='text-2xl p-4'>Subtotal:</p>
                                <p className='text-2xl p-4'>$84.00</p>
                            </div>
                            <div className='border border-gray-200'></div>
                            <div className='flex justify-between items-center'>
                                <p className='text-2xl p-4'>Shipping:</p>
                                <p className='text-2xl p-4'>Free</p>
                            </div>
                            <div className='border border-gray-200'></div>
                            <div className='flex justify-between items-center'>
                                <p className='text-2xl p-4'>Total:</p>
                                <p className='text-2xl p-4'>$84.00</p>
                            </div>
                            <div className='border border-gray-200'></div>
                            <div className='flex justify-center py-4'>
                                <button className='text-xl text-white  bg-green-600 hover:bg-green-700 rounded-full px-40 py-2 items-center'>Proceed to checkout</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div className='flex gap-4 border border-gray-300 w-[820px] p-4 ml-4'>
                    <p className='text-2xl font-bold'>Coupon Code</p>
                    <form className="relative max-w-md ">
                        <input
                            type="search"
                            id="default-search"
                            className="w-full md:w-[500px] p-3 text-sm text-gray-900 border border-gray-300 rounded-full bg-gray-50 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400"
                            placeholder="Enter Coupon Code"
                            required
                        />
                        <button
                            type="submit"
                            className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-green-700 text-white hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-full text-sm mr-[-170px] px-4 py-3"
                        >
                            Search
                        </button>
                    </form>
